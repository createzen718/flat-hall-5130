...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-hall-5130)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-hall-5130
```

A live public deployment of this template is available at [https://flat-hall-5130.templates.workers.dev](https://flat-hall-5130.templates.workers.dev)
